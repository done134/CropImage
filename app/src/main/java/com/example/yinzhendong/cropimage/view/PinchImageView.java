...
public class PinchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public Bitmap clip() {
        ...
        draw(canvas);
        return Bitmap.createBitmap(bitmap,width+1,
                height+1, horizontalPadding - 2,
                verticalPadding - 2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        height = (getHeight() - verticalPadding) / 2;
...
//    canvas.drawRect(horizontalPadding, getHeight() - verticalPadding, getWidth() - horizontalPadding, getHeight(), paint);
        ...
        canvas.drawRect(width, height, horizontalPadding + width, verticalPadding + height, paint);
    }
